                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-4">
                                                  <div class="form-group mb-2">
                                                      ...
                                                      <input type="number" class=" form-control form-control-sm"
                                                          id="text_interes_cliente" placeholder="Interes Cliente"
                                                          disabled>
...
function recalcularPrestamo() {
    ...
    //MODO DE PRESTAMO A 13 CUOTAS Y 10% DE INTERES CONDICIONADO
    if (cuotaQty == 13  & interes == 10) {
    ...
    //MODO DE PRESTAMO NORMAL SI NO SE CUMPLE LA CONDICIONAL DE ARRIBA
    } else {
      var monto_interes = (montoPresta * interes) / 100; //500 *0.20
