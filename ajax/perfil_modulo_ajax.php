...
require_once "../controladores/perfil_modulo_controlador.php";
require_once "../modelos/perfil_modulo_modelo.php";
...
if(isset($_POST['accion']) && $_POST['accion'] == 1){ ///REGISTRAR MODULOS
